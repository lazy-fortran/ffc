...
contains
    ...
    function test_array_declaration() result(passed)
        ...
        arr_idx = push_declaration(arena, "real", ["arr"], kind_value=4)
    ...
    function test_assignment() result(passed)
        ...
        x_idx = push_declaration(arena, "integer", ["x"], kind_value=4)
    ...
    function test_standard_mlir_ops() result(passed)
        ...
        decl_idx = push_declaration(arena, "real", ["x"], kind_value=4)
