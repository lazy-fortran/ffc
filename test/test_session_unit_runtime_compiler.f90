...
contains
    ...
    logical function test_runtime_status_codes() result(ok)
        ...
        write (unit, '(a)') 'int _ffc_unit_open(int, const char *, int,'
        ...
        write (unit, '(a)') '    int plen = (int) sizeof("'//WORK// &
            '/a.dat") - 1;'
        write (unit, '(a)') '    const char *p = "'//WORK//'/a.dat";'
        write (unit, '(a)') '    if (_ffc_unit_is_open(11)) return 1;'
        write (unit, '(a)') '    if (_ffc_unit_open(11, p, plen, "replace"))'
        ...
        write (unit, '(a)') '    if (_ffc_unit_open(first, p, plen, "replace"))'
