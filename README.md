...
logical masks (automatic ranks 1 through 3 and assumed-shape ranks 1 through
2), through the runtime descriptor; runtime-bounded
...
runtime allocation. Scalar `count(a)` also works for logical masks, through
