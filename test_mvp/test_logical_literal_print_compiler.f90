program test_logical_literal_print_compiler
    ...
    character(len=*), parameter :: exe_path = '/tmp/ffc_logical_literal_test'
    character(len=*), parameter :: out_path = '/tmp/ffc_logical_literal_test.out'
    integer :: exit_stat
    integer :: io_stat
    integer :: unit
    ...
    print *, '=== logical literal print compiler test ==='
    ...
    print *, 'PASS: logical literal print'
end program test_logical_literal_print_compiler
