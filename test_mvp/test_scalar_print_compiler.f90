program test_scalar_print_compiler
    ...
    character(len=*), parameter :: exe_path = '/tmp/ffc_scalar_print_test'
    character(len=*), parameter :: out_path = '/tmp/ffc_scalar_print_test.out'
    integer :: exit_stat
    integer :: io_stat
    integer :: unit
    ...
    print *, '=== scalar print compiler test ==='
    ...
    print *, 'PASS: scalar assignment, arithmetic, and print'
end program test_scalar_print_compiler
