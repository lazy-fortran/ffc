program test_scalar_if_compiler
    ...
    character(len=*), parameter :: exe_path = '/tmp/ffc_scalar_if_test'
    character(len=*), parameter :: out_path = '/tmp/ffc_scalar_if_test.out'
    integer :: exit_stat
    integer :: io_stat
    integer :: unit
    character(len=*), parameter :: source = &
        ...
        '  x = 5'//new_line('a')// &
        '  if (x == 5) print *, 1'//new_line('a')// &
        'end program main'

    print *, '=== scalar if compiler test ==='
    ...
    print *, 'PASS: scalar comparison and if'
end program test_scalar_if_compiler
